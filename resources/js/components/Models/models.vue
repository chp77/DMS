            ...
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="col-md-2 card-tools">
                        <router-link to="model-add" class="btn btn-primary btn-add fa-pull-right">Add Model</router-link>
                    </div>
                </div>
            </div>
...
<script>
    ...
    import ModelActionBtn from "../ModelActionBtn.vue";
            ...
            return {
                ...
                tableProps: {
                    ...
                    columns: [
                        ...
                        { key: "name", title: "Model" },
                        { key: "created_at", title: "Created at" },
                        {
                            key: 'actions',
                            title: 'Actions',
                            sortable: false,
                            component: ModelActionBtn,
                        },
                    ],
                    text: {
