            ...
            <div class="header" id="edit-component-header">
                ...
                <div class="card col-md-12 hide-message" style="padding: 0 0 0 0; background-color: #117f2a; color: white;">
                    <div class="card-header">
                        Brand updated successfully, will redirect to the brand listing page in {{counter}} seconds ...
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            const brandId = currentUrl.split("show/");
            
            axios.get(`/brand/edit/${brandId[1]}`)
                .then(response => {
                    if (response.data.statusCode === 200) {
                        const brandInfo = response.data.data;
                        this.form.name = brandInfo.name;
                    } else {
        ...
        methods: {
            updateData() {
                ...
                const brandId2 = currentUrl2.split("show/");

                // API post request
                this.form.post(`/brand/update/${brandId2[1]}`)
                .then(response => {
                    if (response.data.statusCode === 200) {
