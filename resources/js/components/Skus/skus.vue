            ...
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="col-md-2 card-tools">
                        <router-link to="sku-add" class="btn btn-primary btn-add fa-pull-right">Add SKU</router-link>
                    </div>
                </div>
            </div>
...
<script>
    ...
    import SkuActionBtn from "../SkuActionBtn.vue";
            ...
            return {
                ...
                tableProps: {
                    ...
                    columns: [
                        ...
                        { key: "name", title: "SKU code" },
                        { key: "created_at", title: "Created at" },
                        {
                            key: 'actions',
                            title: 'Actions',
                            sortable: false,
                            component: SkuActionBtn,
                        },
                    ],
                    text: {
