            ...
            <div class="header" id="edit-component-header">
                ...
                <div class="card col-md-12 hide-message" style="padding: 0 0 0 0; background-color: #117f2a; color: white;">
                    <div class="card-header">
                        SKU updated successfully, will redirect to the SKU listing page in {{counter}} seconds ...
                    </div>
                </div>
            </div>
                    ...
                    <div class="card card-primary" style="padding: 0 0 0 0;">
                        ...
                        <form @submit.prevent="updateData()">
                                ...
                                <div class="col-md-12">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="input-name">SKU code<span style="color: red;"> *</span></label>
                            ...
                            <div class="card-footer" style="display: row; justify-content: space-between;">
                                <router-link to="/skus" class="btn btn-primary btn-add" style="float: left; background-color: #ccc; border-color: transparent;">Cancel</router-link>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            const skuId = currentUrl.split("show/");
            
            axios.get(`/sku/edit/${skuId[1]}`)
                .then(response => {
                    if (response.data.statusCode === 200) {
                        const skuInfo = response.data.data;
                        this.form.name = skuInfo.name;
                    } else {
        ...
        methods: {
            updateData() {
                ...
                const skuId2 = currentUrl2.split("show/");

                // API post request
                this.form.post(`/sku/update/${skuId2[1]}`)
                .then(response => {
                    if (response.data.statusCode === 200) {
                        ...
                        this.timeoutId = setTimeout(() => {
                            ...
                            this.$router.push('/skus'); // Redirect to the desired route
                        }, 5000); // 5-second delay
                    } else {
                        Toast.fire({
                            icon: 'error',
