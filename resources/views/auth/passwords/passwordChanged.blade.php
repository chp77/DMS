            ...
            <div class="col-md-8">
                <div class="card" style="padding: 50px 80px;">
                    <div class="card-body" style="text-align: center;">
                        ...
                        <label style="color: #1a2340; font-size: 22px; width: 100%; font-weight: 700;">Successful password reset!</label>
                        <p style="font-size: 15px;">You can now use your new password to log in to</p>
                        <p style="line-height: 0; font-size: 15px;">your account 🙌</p>
